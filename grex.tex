In this chapter, we present the instrument design and initial results for the Galactic Radio Explorer (GReX), an all-sky monitor for exceptionally bright transients in the radio sky.
...
\input{grex_paper_cleaned/introduction}
\input{grex_paper_cleaned/hardware}
\input{grex_paper_cleaned/software}
\input{grex_paper_cleaned/deployment}
\input{grex_paper_cleaned/beam_model}
\input{grex_paper_cleaned/sensitivity}
\input{grex_paper_cleaned/results}
\input{grex_paper_cleaned/conclusions}